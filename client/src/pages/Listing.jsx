...
export default function Listing() {
    ...
    const [listing, setListing] = useState(null);//[listing, setListing]
     ...
     <main>{loading && <p className='text-center my-7 text-2xl'>Loading...</p>}
          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            ...
            <ul className=' text-green-900 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6'>
              ...
              {currentUser && listing.userRef !== currentUser._id && !contact && (// this line shows contact landlord button only if u are not the owner
